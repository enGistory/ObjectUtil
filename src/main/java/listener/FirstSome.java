 ...
 * */
@ToString
public class FirstSome implements IListenerable {
    private IListener listener;
    @Resource(name = "firstTask")
    ...
    public void saveStudent(){
        ...
        AbstractListenerStrategy.actionListener(new FirstTask(event));
